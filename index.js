...
function bindCustomPageManagerEvents() {
    const addBtn = document.getElementById('add-input-row');
    if (addBtn) {
        addBtn.onclick = () => addInputRowToForm();
    }
